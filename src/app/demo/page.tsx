        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <Card className="p-6 bg-card border-border">
            ...
            <div className="aspect-[16/9] bg-muted/30 rounded border border-border/50 flex items-center justify-center">
              <div className="text-center space-y-2">
                ...
                <p className="text-xs text-muted-foreground font-mono">Showing portfolio growth in MEIc vs USD denomination</p>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-6 bg-muted/30 border-border">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              This backtest uses historical data from FRED, LBMA, and CoinGecko. Returns are calculated in MEIc units
              using r<sub>i,MEIc</sub> = ∑ ln(P<sub>i</sub><sup>USD</sup> / P<sub>USD</sub><sup>MEIc</sup>). The replicator
              dynamic reweights components based on clipped returns: dw<sub>j</sub> = w<sub>j</sub>[r<sub>j</sub>(λ) - λ
              w<sub>k</sub>r<sub>k</sub>(λ)]dt. Cost gate skips trades when projected fee + impact exceeds the specified
              cap. GINI™ removes global funding costs and MEIc-denominated inflation to isolate skill.
            </p>
          </Card>
        </div>
      </div>
